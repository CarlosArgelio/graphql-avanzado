...
export function findAll(parent: unknown, args: unknown, context: ResolverContext): Promise<Avocado[]> {
...
export const resolver: Record<keyof
  (Avocado & {attributes: Attributes}),
  (parent: (Avocado & {attributes: Attributes}))
  => unknown> = {
  id: (parent) => parent.id,
